...
var OPS_TRIGGER_SPEC = [
  ...
  { fn: 'checkPendingApprovals',     cadence: 'minutely', minutes: 5,                                              label: 'Chore approval check' },
  { fn: 'checkSystemErrors',         cadence: 'minutely', minutes: 15,                                             label: 'System error check' },
  ...
  { fn: 'pushHealthSnapshot',        cadence: 'weekly',  hour: 10, day: 'WEDNESDAY',      tz: 'America/Chicago', label: 'Notion health snapshot' },
  { fn: 'runMonthlyMERReport_',      cadence: 'monthly', hour: 9,  day: 1,                 tz: 'America/Chicago', label: 'Monthly MER report' },
  { fn: 'reconcileVeinPulse',        cadence: 'daily',    hour: 2,  tz: 'America/Chicago',                        label: 'TheVein/ThePulse reconcile' },
  { fn: 'refreshCascadeTabs',        cadence: 'monthly',  hour: 7,  day: 1,                   tz: 'America/Chicago', label: 'Cascade tabs refresh' },
