# Evidence: reading-module — Buggsy evaluation

| Field | Value |
|---|---|
| Surface | reading-module |
| Route | /reading |
| Child | Buggsy |
...
Run the Play gate rubric (ops/play-gate-rubric.v1.json) for reading-module at the buggsy-workstation (Surface Pro 5 1368x912)
