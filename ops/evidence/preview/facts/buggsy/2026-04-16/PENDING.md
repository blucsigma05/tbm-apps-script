# Evidence: fact-sprint — Buggsy evaluation
...
Run the Play gate rubric (ops/play-gate-rubric.v1.json) for fact-sprint at the buggsy-workstation (Surface Pro 5 1368x912)
