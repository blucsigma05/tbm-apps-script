# Evidence: HomeworkModule — Buggsy evaluation

| Field | Value |
|---|---|
| Surface | HomeworkModule |
| Route | /homework |
| Child | Buggsy |
...
Run the Play gate rubric (ops/play-gate-rubric.v1.json) for HomeworkModule at the buggsy-workstation (Surface Pro 5 1368x912)
