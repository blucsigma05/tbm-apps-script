# Evidence: writing-module — Buggsy evaluation

| Field | Value |
|---|---|
| Surface | writing-module |
| Route | /writing |
| Child | Buggsy |
...
Run the Play gate rubric (ops/play-gate-rubric.v1.json) for writing-module at the buggsy-workstation (Surface Pro 5 1368x912)
