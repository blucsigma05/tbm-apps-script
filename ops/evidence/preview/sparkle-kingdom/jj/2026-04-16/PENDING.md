# Evidence: JJHome — JJ evaluation

| Field | Value |
|---|---|
| Surface | JJHome |
| Route | /sparkle-kingdom |
| Child | JJ |
...
Run the Play gate rubric (ops/play-gate-rubric.v1.json) for JJHome at the jj-learning-tablet (Samsung S10 FE 1200x1920)
