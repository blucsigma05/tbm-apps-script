# Evidence: investigation-module — Buggsy evaluation

| Field | Value |
|---|---|
| Surface | investigation-module |
| Route | /investigation |
| Child | Buggsy |
...
Run the Play gate rubric (ops/play-gate-rubric.v1.json) for investigation-module at the buggsy-workstation (Surface Pro 5 1368x912)
