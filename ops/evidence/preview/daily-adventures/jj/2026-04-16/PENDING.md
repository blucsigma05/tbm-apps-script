# Evidence: daily-adventures — JJ evaluation

| Field | Value |
|---|---|
| Surface | daily-adventures |
| Route | /daily-adventures |
| Child | JJ |
...
Run the Play gate rubric (ops/play-gate-rubric.v1.json) for daily-adventures at the jj-learning-tablet (Samsung S10 FE 1200x1920)
