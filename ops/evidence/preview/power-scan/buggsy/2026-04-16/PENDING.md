# Evidence: wolfkid-power-scan — Buggsy evaluation

| Field | Value |
|---|---|
| Surface | wolfkid-power-scan |
| Route | /power-scan |
| Child | Buggsy |
...
Run the Play gate rubric (ops/play-gate-rubric.v1.json) for wolfkid-power-scan at the buggsy-workstation (Surface Pro 5 1368x912)
