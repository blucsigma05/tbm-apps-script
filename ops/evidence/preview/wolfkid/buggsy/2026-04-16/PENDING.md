# Evidence: WolfkidCER — Buggsy evaluation
...
Run the Play gate rubric (ops/play-gate-rubric.v1.json) for WolfkidCER at the buggsy-workstation (Surface Pro 5 1368x912)
