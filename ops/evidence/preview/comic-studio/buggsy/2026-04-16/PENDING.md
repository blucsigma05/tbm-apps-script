# Evidence: ComicStudio — Buggsy evaluation
...
Run the Play gate rubric (ops/play-gate-rubric.v1.json) for ComicStudio at the buggsy-workstation (Surface Pro 5 1368x912)
