# Evidence: SparkleLearning — JJ evaluation

| Field | Value |
|---|---|
| Surface | SparkleLearning |
| Route | /sparkle |
| Child | JJ |
...
Run the Play gate rubric (ops/play-gate-rubric.v1.json) for SparkleLearning at the jj-learning-tablet (Samsung S10 FE 1200x1920)
