# Evidence: BaselineDiagnostic (Buggsy) — Buggsy evaluation

| Field | Value |
|---|---|
| Surface | BaselineDiagnostic (Buggsy) |
| Route | /baseline |
| Child | Buggsy |
...
Run the Play gate rubric (ops/play-gate-rubric.v1.json) for BaselineDiagnostic (Buggsy) at the buggsy-workstation (Surface Pro 5 1368x912)
