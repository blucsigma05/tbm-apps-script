# Evidence: BaselineDiagnostic (JJ) — JJ evaluation

| Field | Value |
|---|---|
| Surface | BaselineDiagnostic (JJ) |
| Route | /baseline |
| Child | JJ |
...
Run the Play gate rubric (ops/play-gate-rubric.v1.json) for BaselineDiagnostic (JJ) at the jj-learning-tablet (Samsung S10 FE 1200x1920)
