...
| Platform | Vault surface migration | Project Memory open items | Planned only | `Vault.html` v1 built. Route wired in Code.js, CF worker, and TheVein nav. ES5 compliant. Sheet-backed with hardcoded fallback. | shipped | Vault.html created, route live. |
