...
Print the verdict JSON. One paragraph of prose summary. Stop.
...
The skill's job is one verdict JSON per invocation, backed by evidence artifacts at the paths named above. No Markdown prose beyond the verdict unless the invoker asks for prose summary explicitly.
